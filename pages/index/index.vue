								...
								<view class="content">
									...
									<view class="labels">
										...
										:style="{color: label.label_color, background: $util.hexToRgba(label.label_color, 0.2)}"
										 v-for="label in product.labels" :key="label.id">{{ label.name }} 
	...
	export default {
		...
		data() {
			return {
				...
				notices: [],
				ads1: [
					"http://5b0988e595225.cdn.sohucs.com/q_70,c_zoom,w_640/images/20171204/f2673d975d6142c190354ba11a75994e.gif",
